...
export default function BuyerKonfirmasi({ visible, onCancel, onComplain, onClose }) {
    return (
                    ...
                    <View className="flex-1 justify-center items-center bg-black/30">
                        <View className="bg-white rounded-2xl p-5 mx-6 shadow-lg w-full max-w-sm">
                            ...
                            <View className="flex-row justify-between mt-4">
                                ...
                                >
                                    <Text className="text-center text-black font-semibold">Kembali</Text>
                                </Pressable>
                                <Pressable
                                    onPress={onComplain}
                                    className="flex-1 py-2 rounded-full bg-blue-100 ml-2"
                                >
                                    <Text className="text-center text-black font-semibold">Konfirmasi</Text>
                                </Pressable>
                            </View>
                        </View>
                    </View>

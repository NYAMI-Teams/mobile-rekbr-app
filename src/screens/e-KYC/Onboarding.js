...
import { StyleSheet, View, Text, Image, TouchableOpacity, SafeAreaView, Animated, Dimensions } from 'react-native';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.bottomSection}>
        <TouchableOpacity
          style={styles.button}
          onPress={() => console.log('Registrasi Sekarang pressed')}
        >
        ...
        <View style={styles.loginContainer}>
          ...
          <TouchableOpacity onPress={() => console.log('Silakan Masuk pressed')}>
...
const styles = StyleSheet.create({
  ...
  illustration: {
    ...
    flexShrink: 0,
    marginBottom: 60, // supaya dots tetap di bawah
  },
  slogan: {
    fontSize: 16,
    color: '#000',
